...
function ChatBox(props) {
    return (<div className={`flex ${props.index % 2 ? 'bg-gray-500' : 'bg-gray-600'} py-3`}>
        <Link href="/customer/message" className="flex">
...
export default function DriverContact() {
    return (<div className="w-screen h-screen bg-primaryBase overflow-y-scroll">
        <div className="text-white bg-primaryMain py-3 flex items-center">
            <Link href="/customer/index">
            <svg className="ml-5 m-auto" xmlns="http://www.w3.org/2000/svg" height="48" width="48" fill="white">
                <path d="M20 44 0 24 20 4l2.8 2.85L5.65 24 22.8 41.15Z" />
            </svg>
            </Link>
            <p className="text-xl absolute left-1/2 -translate-x-1/2">ข้อความ</p>
        </div>
        {chatData.map((e, idx) => {
